var langStr={
	...
	<br> \
	Также если зажать ctrl и кликнуть по метке - показывает меню метки<br> \
	<br>---Меню метки\:<br> \
	можно сменить группу \
	удалить саму метку \
	добавить метку в игнор лист<br> \
	присвоить метке эффект длительности, при этом можно будет несколько раз добавлять её в историю и при дабл клике она скрываться не будет<br> \
	<br>---Меню метки\<br> \
	...
	при первом включении - открывает попап окно где можно как закрыть его, так и пометить метку как пройденая (так же как при двойном клике)  \
	также если не хочется забирать предмет сейчас можно добавить его в игнор лист (пропустить) и забрать позже, при этом продолжить следовать по текущему маршруту \
